...
import { normalizeDataToEarth } from "../utils/dataProcessing";
...
export const useInitiateSolarSystem = () => {
    ...
    useEffect(() => {
      ...
      useSolarSystemStore.getState().addCelestialBodyProperty("sun", "position", new THREE.Vector3(0, 0, 0));
      useSolarSystemStore.getState().addCelestialBodyProperty("sun", "rotation", new THREE.Euler(0, 0, 0));
    }, []); 
